...
namespace HiWorldStateless 
{
    public sealed class SqlHelper
    {
        ...
        #region FormSqlParameter

        /// <summary>
        /// Default value of the Direction is Input
        /// </summary>
        /// <param name="parameterName">Name of the SQL Parameter</param>
        /// <param name="value">Value of the parameter</param>
        /// <param name="sqlDbType">The SqlDbType</param>
        /// <param name="direction">Direction of the SQL Parameter</param>
        /// <returns></returns>
        public static SqlParameter FormSqlParameter(String parameterName,
            Object value,
            System.Data.SqlDbType sqlDbType,
            ParameterDirection direction = ParameterDirection.Input, int Size = 0)
        {
            if (value == null && SqlDbType.Structured != sqlDbType)
            {
                SqlParameter prm = new SqlParameter(parameterName, DBNull.Value);
            ...
            {
                SqlParameter prm = new SqlParameter(parameterName, value);
                prm.SqlDbType = sqlDbType;
                prm.Direction = direction;
                prm.Size = Size;
                return prm;
            ...
            ParameterDirection direction = ParameterDirection.Input)
        {
            ...
            sqlParameter = FormSqlParameter(parameterName, value, sqlDbType, direction);
            ...
            ParameterDirection direction = ParameterDirection.Input)
        {
            ...
            parameter = FormSqlParameter(parameterName, value, sqlDbType, direction);
        ...
        /// <param name="value">The value.</param>
        /// <param name="sqlDbType">Type of the SQL db.</param>
        /// <param name="size">The size of the SQL parameter</param>
        /// <param name="direction">The direction.</param>
        /// <returns></returns>
        public static SqlParameter FormSqlParameter(String parameterName,
            Object value,
